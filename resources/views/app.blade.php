    ...
    <div class="juzaweb__layout juzaweb__layout--hasSider">
            ...
            <div class="juzaweb__menuLeft__outer">
                <div class="juzaweb__menuLeft__logo__container">
                    ...
                    <div class="juzaweb__menuLeft__logo">
                        ...
                        <div class="juzaweb__menuLeft__logo__name">BSSCB</div>
                        <div class="juzaweb__menuLeft__logo__descr">Corp</div>
                    </div>
        ...
        <div class="juzaweb__layout">
            ...
            <div class="juzaweb__layout__content">
                @if(!request()->is(config('bsscb.admin_prefix')))
                    {{ jw_breadcrumb('admin', [
                            [
                                'title' => $title ?? ''
                            ]
        ...
        <div class="juzaweb__layout__footer">
            <div class="juzaweb__footer">
                <div class="juzaweb__footer__inner">
                    <a href="#" target="_blank" rel="noopener noreferrer" class="juzaweb__footer__logo">
                        BSSCB -  website professional
                        <span></span>
                    </a>
                    <br />
                    <p class="mb-0">
                        Copyright © {{ date('Y') }} {{ get_config('title') }} - Provided by Bsscb Programmer
                    </p>
                </div>
            </div>
        </div>
