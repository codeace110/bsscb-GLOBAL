            ...
            <div class="juzaweb__menuLeft__logo__container">
                ...
                {{--<div class="juzaweb__menuLeft__logo">
                    <div class="juzaweb__menuLeft__logo__name">
                        <a href="/{{ config('juzaweb.admin_prefix') }}">
                            <img src="{{ asset('jw-styles/juzaweb/images/blogo.png') }}" class="w-100" alt="Juzaweb Logo">
                        </a>
                    </div>
                </div>--}}
            </div>
            ...
            <div class="juzaweb__footer">
                <div class="juzaweb__footer__inner">
                    <a href="#" target="_blank" rel="noopener noreferrer" class="juzaweb__footer__logo">
                        BSSCB - website Blog professionals
                        <span></span>
                    </a>
                    <br />
                    <p class="mb-0">
                        Copyright © 2023 {{ get_config('title') }} - Provided by BSSCB Programmer
                    </p>
                </div>
            </div>
        </div>
